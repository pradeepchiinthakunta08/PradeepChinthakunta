...
let baseSalaries = [75000, 68000, 82000, 90000, 60000];
let experiences = [5.1, 3.2, 7.1, 10.2, 2.4];
let ratings = [4.2, 3.8, 4.5, 2.5, 3.5];
...
for (let i = 0; i < employeeNames.length; i++) {
    ...
    // Calculate Hike
    let hike = (baseSalaries[i] * variablePay / 100) +
        bonus +
        reward;
